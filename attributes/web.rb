...
default['magentostack']['web']['user'] = nil
default['magentostack']['web']['group'] = nil
...
default['magentostack']['web']['ssl_key'] = "/etc/ssl/#{site_name}.key"
default['magentostack']['web']['ssl_cert'] = "/etc/ssl/#{site_name}.pem"
